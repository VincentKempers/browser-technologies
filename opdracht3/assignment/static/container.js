if (document.addEventListener) {
  ...
  function showPicture(event) {
    ...
    imageShow.innerHTML = "<img src='static/imgs/random-user_imageM4.jpg' alt=''> <p>"+ phoneNumbers +"</p> <p>407 Cummings Point Apt. 883</p> <p><a href='mailto:Emory_Schmitt22@hotmail.com'>Emory_Schmitt22@hotmail.com</a></p> <p>"+ Math.floor(Math.random() * 2000 + 1) + " </p>";
